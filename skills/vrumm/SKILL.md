...
name: vrumm
description: >
  Creates a new working branch (fix- or feat-) from upstream/staging or upstream/main.
  Use when user says "/vrumm", "create branch", "nova branch", "start feature", "start fix",
